...
- [ ] **A1. Game structure** — 60-minute game, three 20-minute periods
- [ ] **A2. Team composition** — 10 players per team: 3 motorcyclists, 2 catchers, 5 skaters
- [ ] **A3. Circular track** — Counterclockwise movement around a circular track
- [ ] **A4. Two goals** — Located opposite each other in the outer wall
- [ ] **A5. Ball firing** — Steel game ball fired from cannon at start of each period
- [ ] **A6. Catcher fielding** — Only catchers can initially pick up a fresh ball
- [ ] **A7. Hand-off to skater** — Catcher hands ball to a skater; only skaters can score
- [ ] **A8. Ball activation** — Team with ball must complete one full lap to the sector where catcher fielded it to "activate" the ball and become the offense
- [ ] **A9. Three-lap limit** — Offense has three laps to make a scoring attempt or ball is declared dead
- [ ] **A10. Dead ball** — Ball declared dead if: rolls into gutter, dropped inside white line, or three-lap limit expires; new ball fired immediately
...
- [ ] **A12. Ball stealing** — Defense may steal the ball; stealing team must complete a lap from the steal sector to activate for their team (switches offense/defense)
...
- [ ] **B1. Ball must remain in sight at all times** — No fakes or hidden ball tricks (automatic rule)
...
- [ ] **B3. Ball may not be used as a weapon** — Penalty: 3 minutes + dead ball
...
- [ ] **B5. Max two figures stopped** — A team may have at most 2 figures stopped on track at any time; exceptions: defensive screen at activated goal (up to 5 skaters + 2 catchers), injured/unconscious/dead figures don't count; penalty: 3 min per extra figure
- [ ] **B6. Skaters/catchers may not attack bikers** — Penalty: 3 minutes (includes grabbing a ride on opposing bike)
- [ ] **B7. Bikers may not attack anyone** — No sideswipe, ram, or run over; penalty: 3 minutes
...
- [ ] **B9. Penalties on scoring attempts** — Any penalty on offense during the scoring turn negates the goal
- [ ] **B10. No attacking fallen/prone figures** — May not attack downed, injured, unconscious, or figures attempting to stand; "out of contention" hand-raise means immune from attack; penalty: 3 min; exception: biker knocked off motorcycle or crash landing on downed figure
- [ ] **B11. Max figures on field** — Max 10 per team: 5 skaters, 2 catchers, 3 bikers (automatic rule); can field fewer due to penalties/injuries but cannot exceed type maximums; no extra figures sent to help injured off track
- [ ] **B12. Keep it on the track** — No fighting in infield; refs cannot be attacked; attacking a ref = automatic immediate expulsion

### Referees

- [ ] **B13. Three referees** — Two on floor (180° view each), one controller in tower following ball (180° view facing ball)
- [ ] **B14. Referee detection** — Base rating 8; roll 2d6 ≤ 8 to spot infraction; -2 if infraction is on far side of track from ball
- [ ] **B15. Scoring attempt ref focus** — All three refs roll for violations in the goal sector during scoring attempts
- [ ] **B16. Penalty enforcement** — Guilty figure removed to penalty box at appropriate time; moved 1 box per game turn; no substitutes for penalized figures; penalty times carry over between periods

---

## C. The Track / Game Board

- [ ] **C1. 12 sectors** — Circular track divided into 12 equal pie-slice sectors (A through L)
- [ ] **C2. Rings/zones** — Each sector has 5 rings: floor/gutter (1 square), lower track (2 squares), middle track (3 squares), upper track (4 squares), cannon track/rail (4 squares, movement-restricted)
- [ ] **C3. Total squares** — Floor: 12 total (1/sector), Lower: 24 (2/sector), Middle: 36 (3/sector), Upper: 48 (4/sector)
- [ ] **C4. Square capacity** — Incline squares: 4 slots (4 skaters, or 2 bikers, or 2 skaters + 1 bike); Floor squares: 6 slots (6 skaters or 3 bikers)
- [ ] **C5. Slot placement** — Figures must be placed in a specific slot (quarter for incline, sixth for floor); default is lower-left if no preference; no rearranging after initiative moves on
- [ ] **C6. Controlling a square** — Team with >50% upright figures in a square controls it; opponents cannot pass through or stop in it without an Assault
- [ ] **C7. Cannon track separation** — Cannon track is separate from upper track; cannot be used for normal movement; first turn after firing, ball is in cannon track and can't hit figures unless deliberately placed or thrown there via wreck
- [ ] **C8. Initiative order within a sector** — Floor ring first, then lower, middle, upper, cannon; within each ring: left to right; within same square: left to right, inside to outside
- [ ] **C9. Orientation** — Left/right as seen from infield (center of circle); "behind"/"back" = to the right; "forward"/"ahead" = to the left

### Incline Movement Effects

- [ ] **C10. Downhill speed bonus** — Moving down 1 ring: +1; immediately down another: +2 more; immediately down a 3rd: +2 more (max +5 from upper to floor); non-consecutive downhill moves give +1 each
- [ ] **C11. Uphill speed cost** — Moving up 1 ring: costs 1 extra (2 total per square); immediately up another: costs 2 extra (3 total); immediately up a 3rd: costs 2 extra; non-consecutive uphill moves cost 1 extra each
...
- [ ] **C16. Unfielded ball obstacle** — Skaters/bikers entering a square with an unfielded ball must make skill roll (exception: catcher present in square)
- [ ] **C17. Ball bounce on obstacle/bobble** — Roll 3d6, subtract from speed; if result > speed, ball stops; otherwise new speed = old speed - result; roll direction die for new direction; hot/very hot ball becomes not-hot after bobble
- [ ] **C18. Dropped ball rolling** — Dropped ball rolls downhill next turn at speed 1 with normal downhill bonuses; reaches gutter same turn if nobody fields it
- [ ] **C19. Ball pickup after drop** — Figure in same square may attempt skill roll to pick up (requires an action); if they fail, other figures in square may attempt in order (left to right, bottom to top)
- [ ] **C20. Goals** — Two goals opposite each other; home and visitor goals with scoring lines
...
- [ ] **D1. Four stats** — Speed (green), Skill (yellow), Combat (orange), Toughness (blue)
- [ ] **D2. Speed** — Max movement points per turn; skaters 5–7; figure can use any number up to max; no penalty for acceleration from standstill; entering track from infield = 1 square; standing up from fall = full movement; temporary boosts from downhill/towing
- [ ] **D3. Skill** — Represents balance, skating, hand-eye coordination; range 6–11; skill check = roll 2d6 ≤ skill (± modifiers); used for: ball pickup, scoring, hand-offs, keeping ball during fights/falls, balance after fights, avoiding obstacles, standing up
- [ ] **D4. Combat** — Fighting ability; range 5–10; each side sums combat values + modifiers + 2d6; compare totals; look up difference on Combat Table
- [ ] **D5. Toughness** — Conditioning/endurance; range 6–11; toughness check = roll 2d6 ≤ toughness; checked after fights/wrecks; failure leads to injury dice roll

### Injury System

- [ ] **D6. Injury dice** — Roll pair of injury dice (6-sided: head, left arm, right arm, left leg, right leg, body); results depend on combination and fatality flag
- [ ] **D7. No-fatality injury results** — Body + any limb/head = Shaken 1–3 min; Body + body = Badly Shaken 4–6 min; Doubles of limb = limb injured (rest of game) + shaken 4–6 min; Doubles of head = knocked unconscious (out for game)
- [ ] **D8. Fatality injury results** — Body + any limb/head = Badly Shaken 4–6 min; Doubles of limb = broken (out for game); Doubles of body or head = Fatality (death)
- [ ] **D9. Blue Die of Death (BDD)** — Third injury die added when called for; increases likelihood of injury, not severity
- [ ] **D10. No injury on no combination** — If dice don't form a combination, no injury at all regardless of circumstances

### Shaken / Injured / Recovery

- [ ] **D11. Shaken** — Figure must leave field temporarily; if stays: -1 to all stats (badly shaken: -2); cumulative; must sit out full shaken time to recover
- [ ] **D12. Injured** — -2 to all stats; toughness checks become automatic injury dice rolls; must make extra skill roll to hold ball; broken arm: -4 to all stats (can optionally play); broken leg or head injury: out for game
- [ ] **D13. Recovery** — Place figure in time box; advance 1 box per game turn; at 0:00 may return; early return = still penalized
- [ ] **D14. Substitutions** — Same-type substitute enters when original leaves field; figure on track (any condition) = "in play", no substitute allowed

### Falling Down & Getting Up

- [ ] **D15. Falling** — Failed skill roll after fight or obstacle = fall; fallen figure may not be attacked (penalty check for attacker)
...
- [ ] **D17. Fallen figure limitations** — No actions; fallen catcher can't field ball or protect teammates from unfielded ball; BUT can hand off ball, fight, and attempt to score (these are NOT actions)
- [ ] **D18. Injured/shaken standing** — Must make adjusted skill roll to stand; continue attempting each turn until successful
- [ ] **D19. "Out of contention"** — Shaken/injured figure attempting to leave can raise hand; immune from attack; drawing a penalty if attacked

### Actions

- [ ] **D20. One action per turn** — Each figure gets: one move, one fight, one scoring attempt (if applicable), plus one action
- [ ] **D21. Action definition** — Anything requiring skill check or effort outside of moving/fighting/scoring (e.g., fielding ball, taking hand-off, righting fallen cycle, helping injured player off field)
- [ ] **D22. Non-actions** — Letting go of tow bar, handing off ball (without opponents present) are NOT actions
- [ ] **D23. Action limit** — If action already used this turn, cannot attempt another even if in position to do so

### Catchers

- [ ] **D24. Catcher purpose** — Field game ball and hand off to skater; fielding = skill roll + action; must release bike tow bar to field
- [ ] **D25. Ball moving through catcher's square** — May attempt to field during ball's movement; if caught, wait until movement phase to hand off
- [ ] **D26. Hot ball fielding danger** — Cannon track ball: -4 skill + automatic fatal injury dice with BDD; Very hot (top half upper ring): -2 skill + toughness check -1; Hot (bottom half upper ring): -1 skill + toughness check
- [ ] **D27. Bobbled ball** — Miss skill by 1 or 2: ball loses 3d6 speed, bounces random direction; if hot/very hot: skip toughness check, roll 2 non-fatal injury dice
- [ ] **D28. Hand-off rules** — Not an action; no skill roll needed unless opposing player in same square; -1 per opposing player in square or base-to-base contact
- [ ] **D29. Catcher drop rules** — Cannot re-attempt pickup same turn as fielding; otherwise can use action to attempt pickup
- [ ] **D30. Four catchers per team** — Two on field at a time; if all 4 incapacitated, regular skater can substitute as catcher with -3 to fielding skill checks
- [ ] **D31. Catcher chart implementation** — Roll ≤ skill: caught; 1–2 over: bobbled; 3+ over: complete miss; with all modifiers
...
- [ ] **E1. Biker stats** — Speed (2 min / 12 max), Skill (driving ability), Combat (low, +5 when using bike as weapon — illegal), Toughness (post-fight/wreck checks)
- [ ] **E2. Biker purpose** — Solely to help skaters go higher/faster; cannot score, cannot fight legally
...
- [ ] **E5. Bike slot placement** — Bike takes 2 slots (half a square); must end in top or bottom half; must be within single square boundary
...
- [ ] **E19. Cycle Chart implementation** — Full 2d6 chart with modifiers (min speed -5, missed by 1: -1, unfielded ball top ring +5, 2+ bikes +2); results from OK (2–3) through Major Wreck (13+)
- [ ] **E20. Explosion rules** — Roll d6 for explosion chance; fire area depends on severity; fire trickles downhill; Big Explosion covers 2 squares on ring + 2 below; biker in fire rolls injury dice again
...
- [ ] **F1. Scoring requirements** — Ball must be activated; only skaters; only from squares touching scoring line in goal sector
- [ ] **F2. Scoring skill roll** — Roll ≤ modified skill to score; magnet triggers on success
- [ ] **F3. Scoring modifiers** — Distance from goal (-1/square), standing opponents between shooter and goal (-1 each), moving shot perpendicular (-1), prone (-4), engaged in man-to-man (-2), 3rd figure in m2m (-2), defense decisive (-1), defense block/breakaway (-2), offense decisive (+1), offense breakthrough/breakaway (+2), offense crush (+4), directly against goal (+2)
- [ ] **F4. Combat effects on shooting** — Breakthrough/Breakaway/Crush for offense gives bonus even if shooter didn't fight; man-to-man with shooter interferes but doesn't prevent shot
- [ ] **F5. Fallen shooter** — Can shoot at -4; shaken/injured during combat this turn also applies
- [ ] **F6. Broken arm auto-drop** — Figure with broken arm automatically drops ball before shooting
- [ ] **F7. Standing defenders only** — Only standing opponents block shots; defenders get bonus from Block/Breakaway results

### Hit or Miss

- [ ] **F8. Missed shot die** — 50% dead ball; 25% bounces to square left of line; 25% bounces to square right of line
- [ ] **F9. Dropped ball after miss** — Rolls downhill to gutter next turn; figures in path may expend action + skill check to pick up (catchers get +2)
...
- [ ] **G1. One fight per turn** — Each figure may engage in one fight per game turn (attacker or defender)
- [ ] **G2. Combat resolution** — Each side: sum combat values + modifiers + 2d6; higher total wins; difference looked up on combat chart
- [ ] **G3. Three combat chart columns** — Skill Checks (always first), then Brawl Results or Assault Results depending on fight type
- [ ] **G4. Four combat types** — Brawling, Man to Man, Assault, The Swoop

### Combat Table — Skill Checks Column

- [ ] **G5. Difference 0–2** — All make skill roll; fail = fall + toughness check; no fatalities on injury dice
- [ ] **G6. Difference 3–5** — Losers roll skill; fail = fall + toughness check; no fatalities
- [ ] **G7. Difference 6–8** — Losers roll skill -1; fail = fall + toughness check; no fatalities
- [ ] **G8. Difference 9–11** — Losers roll skill -2; fall + toughness -1; fatality on injury dice
- [ ] **G9. Difference 12–14** — Losers roll skill -3; fall + toughness -2; fatality on injury dice
- [ ] **G10. Difference 15+** — Losers automatically fall; toughness -3; fatality with Blue Die of Death

### Brawling

- [ ] **G11. Base-to-base requirement** — Fight only between figures in base-to-base contact (side-by-side or end-to-end, NOT diagonal)
...
- [ ] **G14. Single roll per side** — One 2d6 roll for each side; results apply to all active participants

### Brawl Results Column

- [ ] **G15. Difference 0–2: Indecisive** — All standing participants go man-to-man
- [ ] **G16. Difference 3–5: Marginal** — Winning side may choose to go man-to-man
- [ ] **G17. Difference 6–8: Decisive** — If winners above or behind, may switch with losers (not if losers controlled square without Assault declared)
- [ ] **G18. Difference 9–11: Breakthrough** — Winners may switch squares with losers
- [ ] **G19. Difference 12–14: Breakaway** — Winners switch with losers + move 1 forward; losers move 1 back
- [ ] **G20. Difference 15+: Breakaway** — Same as 12–14

### Man to Man

- [ ] **G21. Man-to-man pairing** — Even numbers: pair off with nearest opponent; odd figure out may move or double up
- [ ] **G22. Man-to-man drift** — First turn: drift 3 squares forward in same ring; second turn: 2; decreasing by 1 each turn until stopped; obstacle skill checks at -2 for both
- [ ] **G23. Man-to-man continuation** — Continue fighting until one or both fall; winner must break off or risk penalty for attacking fallen figure
- [ ] **G24. Upper hand bonus** — Slightly higher result in man-to-man gets +1 next round; no positional advantage (both locked together)
- [ ] **G25. Joining man-to-man** — Additional figures joining = treated as regular brawl; if man-to-man results again, original pair stays, new opponents pair off
- [ ] **G26. Man-to-man limitations** — No actions; catchers can't field ball or protect teammates; CAN hand off ball (-2 to teammate's skill) and CAN make scoring attempt (-2)

### Assaults

- [ ] **G27. Assault purpose** — Take over a controlled square
- [ ] **G28. Assault max participants** — 8 total (4 per side); nearby figures can support
- [ ] **G29. Assault winning side skill check** — ALL winners must make skill roll -1 to stay on feet regardless of result
- [ ] **G30. Assault results: 0–2 Fails** — All stay in original squares
- [ ] **G31. Assault results: 3–5 Marginal** — Original team keeps control; winner may push 1 figure in if open slot
- [ ] **G32. Assault results: 6–8 Decisive** — Losers lose control; winners may switch 2 figures; fallen losers pushed to nearest open square
- [ ] **G33. Assault results: 9–11 Breakthrough/Block** — Winners gain/keep control; may switch with losers
- [ ] **G34. Assault results: 12–14 Breakthrough/Block** — Winners gain/keep; push losers back 1 square
- [ ] **G35. Assault results: 15+ Crush** — Winners gain/keep; push losers back 1 square
- [ ] **G36. Goal sector push direction** — If defense controlling goal square: 50% pushed left, 50% pushed right (even/odd die roll)

### The Swoop

- [ ] **G37. Swoop definition** — Single figure uses incline to build speed and tackles/dropkicks opponent; swooper automatically falls
- [ ] **G38. Swoop priority** — Resolved FIRST before any other combat in the sector; no other figures can join
...
- [ ] **G41. Swoop vs biker** — Decisive or higher = biker skips skill check, auto-rolls cycle chart
- [ ] **G42. Swoop vs man-to-man pair** — Can swoop the pair, but attack targets BOTH — risk injuring own teammate
- [ ] **G43. Swoop winner** — Does not make toughness check (landed correctly); loser: toughness -1 penalty in addition to normal checks
...
- [ ] **G47. Using ball as weapon** — +3 (skill check + penalty check)
- [ ] **G48. Team controls square** — +1
- [ ] **G49. Upper hand in man-to-man** — +1
- [ ] **G50. Moving vs standing** — +2 (single modifier regardless of participant count)
...
- [ ] **G53. Swoop bonus** — +2 (attacker automatically falls)
- [ ] **G54. Shaken/injured penalty** — -1 / -2
- [ ] **G55. Attacking fallen figure (illegal)** — +4 (penalty check)
- [ ] **G56. Skater hitting biker (illegal)** — +4 (penalty check)
- [ ] **G57. Using bike as weapon (illegal)** — +5 (penalty check)
...
- [ ] **H2. Maximum penalties allowed** — Figure ejected after 5 penalties (configurable: 4–6)
...
- [ ] **I2. Penalty dice always rolled** — Regardless of whether penalty is actually called, dice are rolled for every infraction
